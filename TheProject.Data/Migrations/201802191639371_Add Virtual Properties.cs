namespace TheProject.Data.Migrations
{
    ...
    public partial class AddVirtualProperties : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Region = c.String(),
                        BoundryPolygon_Id = c.Int(),
                        GPSCoordinates_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.BoundryPolygons", t => t.BoundryPolygon_Id)
                .ForeignKey("dbo.GPSCoordinates", t => t.GPSCoordinates_Id)
                .Index(t => t.BoundryPolygon_Id)
                .Index(t => t.GPSCoordinates_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Locations", "BoundryPolygon_Id", "dbo.BoundryPolygons");
            ...
            DropIndex("dbo.Locations", new[] { "BoundryPolygon_Id" });
